 ...
 *
 * @package WordPress
 * @subpackage FosterPress
 * @since FosterPress 2.6.0
 */
...
function fosterpress_custom_sizes( $sizes ) {
...
add_filter( 'image_size_names_choose', 'fosterpress_custom_sizes' );

// Add custom image sizes attribute to enhance responsive image functionality for content images
function fosterpress_adjust_image_sizes_attr( $sizes, $size ) {
...
add_filter( 'wp_calculate_image_sizes', 'fosterpress_adjust_image_sizes_attr', 10 , 2 );
