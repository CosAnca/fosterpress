<?php
/**
 * FosterPress Comments
 *
 * @package FosterPress
 */

if ( ! class_exists( 'fosterpress_Comments' ) ) :
class fosterpress_Comments extends Walker_Comment {
	...
	function __construct() { ?>
		...
		<h3><?php comments_number( __( 'No Responses to', 'fosterpress' ), __( 'One Response to', 'fosterpress' ), __( '% Responses to', 'fosterpress' ) ); ?> &#8220;<?php the_title(); ?>&#8221;</h3>
	...
	function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
		...
		<header class="comment-author">
			...
			<?php
				...
				printf( __(
					'<cite class="fn">%s</cite>', 'fosterpress' ),
