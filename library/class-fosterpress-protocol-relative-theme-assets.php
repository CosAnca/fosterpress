 ...
 *
 * @package FosterPress
 * @since FosterPress 1.1.0
 */

if ( ! class_exists( 'fosterpress_Protocol_Relative_Theme_Assets' ) ) :
	class fosterpress_Protocol_Relative_Theme_Assets {
		/**
	...
	$fosterpress_protocol_relative_theme_assets = new fosterpress_Protocol_Relative_Theme_Assets;
endif;
